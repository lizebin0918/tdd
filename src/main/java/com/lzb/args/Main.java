 ...
 * 如果参数中没有指定某个标志，那么解析器应该指定一个默认值。例如，false 代表布尔值，0 代表数字，”"代表字符串，
 * []代表列表。如果给出的参数与模式不匹配，重要的是给出一个好的错误信息，准确地解释什么是错误的。　
 * 确保你的代码是可扩展的，即如何增加新的数值类型是直接和明显的。
 *
 *
 * Created on : 2022-04-17 21:48
 *
 * @author lizebin
 */
@Slf4j
...
//            executeApplication(logging, port, dir);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
