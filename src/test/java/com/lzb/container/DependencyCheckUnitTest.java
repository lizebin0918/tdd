...
class DependencyCheckUnitTest extends BaseUnitTest {
    ...
    void should_ABC_dependency() {
        ...
        DependencyA dependencyA = (DependencyA) context.get(Context.Ref.of(DependencyA.class))
                .orElseThrow();
        assertThat(dependencyA).isNotNull();

        DependencyB dependencyB = (DependencyB) context.get(Context.Ref.of(DependencyB.class))
                .orElseThrow();
        assertThat(dependencyB).isNotNull();

        DependencyC dependencyC = (DependencyC) context.get(Context.Ref.of(DependencyC.class))
                .orElseThrow();
    ...
    void should_bind_orderly() {
        ...
        Context context = contextConfig.getContext();
        DependencyD dependencyD = (DependencyD) context.get(Context.Ref.of(DependencyD.class))
                .orElseThrow();
    ...
    void should_not_throw_exception_if_cyclic_dependency_via_provider() {
        ...
        Context context = contextConfig.getContext();
        assertTrue(context.get(Context.Ref.of(Component.class))
                .isPresent());
    }
